...
# Project Assignment
This document is the course project submission - Practical Machine Learning.
...
The training and testing data were saved as "training_cleaned.csv" and testing_cleaned.csv.

```{r}
setwd("~/Documents/DataScienceCourse2015/08_Practical Machine Learning/")

# Loading the training and testing data that is cleaned
training <- read.table(file = "./pml-training_cleaned.csv", header = TRUE, sep = ",", quote = "")
testing <- read.table(file =  "./pml-testing_cleaned.csv", header = TRUE, sep = ",", quote = "")
...
Perform Cross Validation to find the out of sample errors. 
...
pml_write_files = function(x){
  n = length(x)
  for(i in 1:n){
    filename = paste0("./for_submission/problem_id_", i ,".txt")
